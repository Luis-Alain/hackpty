...
export function validatePhoneLifecycle(report: PhoneLifecycleEvidence, receipt: CaptureReceipt) {
  ...
  return { status: 'passed', scope: 'Native Android lifecycle bound to this camera photo and durable receipt', apkSha256: report.build.apkSha256, transferId: receipt.transferId };
}
