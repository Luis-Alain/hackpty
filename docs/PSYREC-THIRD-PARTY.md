...
| MedPsy-1.7B Q4_K_M imatrix GGUF (evaluation candidate, September 9; SDK registry constant `HEALTHCARE_1_7B_MEDICAL_Q4_K_M`; not in the production manifest unless the chart-review evaluation gates pass) | Tether AI Research / Tether Data, S.A. de C.V.; post-trained on the Qwen3-1.7B thinking backbone | Apache-2.0, [pinned GGUF revision](https://huggingface.co/qvac/MedPsy-1.7B-GGUF/tree/fd4cecc90c2de8dce4b112795456a54be9c59363), [provisioning receipt](../artifacts/evidence/medpsy-1.7b-provisioning.json) with verified bytes and SHA-256 |
